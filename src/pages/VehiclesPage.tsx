...
import { Truck, Plus, Search, Edit2, Trash2, Upload, Download, LayoutGrid, List as ListIcon, CheckSquare, Sun, Moon, Info, LogOut, X } from 'lucide-react';
          ...
          >
            <div className="flex items-center gap-2 pr-4 border-r border-[var(--border-subtle)]">
              ...
              <span className="text-[13px] font-medium text-[var(--text-secondary)]">
                {selectedIds.size === 1 ? 'Veículo selecionado' : 'Veículos selecionados'}
              </span>
            </div>
