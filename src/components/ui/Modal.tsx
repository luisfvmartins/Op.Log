      ...
      {isOpen && (
        <>
          ...
          <motion.div
            ...
            className="fixed left-1/2 top-1/2 z-50 w-full max-w-lg -translate-x-1/2 -translate-y-1/2 bg-white dark:bg-[#09090B] border border-slate-200 dark:border-white/10 rounded-xl shadow-2xl p-6"
          >
